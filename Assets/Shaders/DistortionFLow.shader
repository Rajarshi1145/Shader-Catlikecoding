Shader "Custom/DistortionFlow" {
	Properties{
		...
		_Amount("Distortion Amount", Float)=1
	}
		SubShader{
			...
			float _UJump, _VJump, _Tiling, _Speed, _FlowStrength, _FlowOffset, _Amount;
			...
			{	
				...
				fixed height = tex2Dlod(_NormalMap, float4(vertexData.texcoord.xy, 0, 0)).r;
				vertexData.vertex.y += normal * height * _Amount;
			}
